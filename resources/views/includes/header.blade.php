<div>
    <div class="mx-auto d-flex flex-lg-row flex-column hero">
        ...
        <div
            ...
            <p class="text-caption">MULAI MEMBANTU DENGAN BERDONASI</p>
            <h1 class="title-text-big">
                Berbuat kebaikan<br class="d-lg-block d-none" />
                dengan berdonasi untuk ummat.
            </h1>
            <div class="d-flex flex-sm-row flex-column align-items-center mx-lg-0 mx-auto justify-content-center gap-3">
                <a href="{{ route('register') }}" class="btn d-inline-flex mb-md-0 btn-try text-white">
                    Daftar
                </a>
                <a href="#program_donasi" class="btn btn-outline">
        ...
        <div class="right-column text-center d-flex justify-content-center pe-0">
            <img id="img-fluid" class="h-auto mw-100" src="{{ asset('assets/images/material/bg.png') }}" alt="" />
